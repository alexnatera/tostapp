...
const levelLabel: Record<string, string> = {
  light: "Light — tueste claro",
  medium: "Medium — tueste medio",
  dark: "Dark — tueste oscuro",
};
    ...
    <div className="min-h-screen bg-amber-50">
      <div className="max-w-lg mx-auto px-4 py-10 space-y-6">
        ...
        <div className="text-center pt-4">
          <p className="text-xs text-amber-400">Creado con</p>
          <a href="/" className="text-sm font-semibold text-amber-700 hover:underline">☕ Tostapp</a>
        </div>
      </div>
    </div>
  );
